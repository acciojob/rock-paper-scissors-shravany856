...
function userChoice(e){
    if(round > 0){
        ...
        //generate coputer choice from rock paper and scissor
        let choices = ["rock", "paper", "scissor"];
        let compChoice = choices[Math.floor(Math.random() * 3)];
        console.log("comp choice",compChoice);

        // compare the user choice and computer choice for possible outcomes

        // where user is going win
        let roundRes = "draw";
